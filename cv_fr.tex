...
\begin{document}
	\maketitle
	\section{Expériences}
		\cventry{Depuis Septembre 2016}{Ingénieur DevOps}{Stormshield}{Lyon}{France}{
			\begin{itemize}
				\item Amélioration du produit d'analyse comportemental de fichier dans le cloud
				\item Réalisation d'un outils de simulation d'internet
				\item Conception et réalisation d'un outils de télémetrie utilisé par tous les produits
				\item Conception et réalisation d'un outils commun de gestion des traductions
				\item Réalisation d'un OS ganeti pour instancier dynamiquement des machine virtuel SNS
			\end{itemize}
			\textit{Technologies :} Python, C++, C, Go, MongoDB, gRPC, CI/CD, Ansible, Jenkins, ReactJS
		}
		\cventry{Depuis September 2013}{Enseignant en developpement informatique}{CPE}{Lyon}{France}{
			\begin{itemize}
				\item Initiation a la programmation en C et Python
				\item Enseignement de la programmation système en C et Python
			\end{itemize}
		}
		\cventry{Janvier 2015\\à Septembre 2016}{Ingénieur en développement}{Qualistream}{Lyon}{France}{
			\begin{itemize}
				...
				\item Formation chez les clients
				\item Recolte des besoins clients
			\end{itemize}
		...
		\cventry{Septembre 2012\\à Janvier 2013}{Ingénieur en informatique Industriel}{ADENEO}{Saint Priest}{France}{
			...
			\end{itemize}
			\textit{Technologies :} C, XML, XSL, CANalyser, outils VECTOR
		}
		\cventry{Septembre 2009\\à Septembre 2012}{Ingénieur en informatique en apprentisage}{Electricité De France}{Villeurbanne}{France}{
			...
			\end{itemize}
			\textit{Technologies :} Python, Ruby, HTML, XML, XSL, GNU/Linux, Cluster de calcul, calcul scientifique, C, Shell
		}
...
%			\end{itemize}
%			\textit{Technologies :} Assembleur, C, $\mu$C/OS II, CAN, SPI, USART, PIC18F, M32, STM32
%		}
	\section{Formations}
...
%		\cventry{2005-2006}{Bac Scientifique avec mention}{Lycée Edouart Branly}{Lyon 5}{}{Option Sciences de l'Ingénieur - Spécialité Maths}
	\section{Compétences}%
		\subsection{Informatique}%
			\cvcomputer{Langages}{Python, C, C++, Go, Ruby, SQL, JS, \LaTeX}{Systèmes d'exploitations}{GNU/Linux, Mac OS X, $\mu$C/OS II, Windows}
			\cvcomputer{Base de données}{MySQL, PostgreSQL, MongoDB}{Outils}{Git, Ansible, Docker, Jenkins, Drone, Travis}
		\subsection{Langues}
